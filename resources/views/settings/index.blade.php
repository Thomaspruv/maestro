...
@section('content')
    <div class="mx-auto max-w-2xl space-y-6">
        ...
        {{-- Intégrations MCP --}}
        <div class="maestro-card p-5">
            <h2 class="mb-1 text-sm font-semibold text-text-primary">Intégrations MCP</h2>
            <p class="mb-4 text-[11px] text-text-muted">
                Générez des tokens pour connecter Hermes, Claude Code ou Claude Cowork.
            </p>
            <a href="{{ route('settings.mcp') }}" class="maestro-btn-secondary inline-flex text-[12px]">
                Gérer les accès MCP →
            </a>
        </div>
