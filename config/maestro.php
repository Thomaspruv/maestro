...
return [
    ...
    */
    ...
    'default_models' => [
        ...
        'test_lead' => 'claude-sonnet-4-6',
        'security' => 'claude-haiku-4-5',
        'dev' => 'claude-haiku-4-5',
        'qa' => 'claude-haiku-4-5',
        'qa_ux' => 'claude-haiku-4-5',
    ...
    'default_pipelines' => [
        'feature' => ['pm', 'test_lead', 'ux', 'security', 'qa', 'qa_ux', 'pr_expert', 'doc'],
        'bug' => ['test_lead', 'security', 'qa', 'qa_ux', 'pr_expert', 'doc'],
        'improvement' => ['pm', 'test_lead', 'security', 'qa', 'qa_ux', 'pr_expert', 'doc'],
        'chore' => ['test_lead', 'pr_expert'],
    ],
    ...
    'role_labels' => [
        ...
        'test_lead' => ['emoji' => '📋', 'name' => 'Test Lead'],
        'security' => ['emoji' => '🔒', 'name' => 'Security'],
        'dev' => ['emoji' => '💻', 'name' => 'Dev'],
        'qa' => ['emoji' => '🧪', 'name' => 'QA'],
        'qa_ux' => ['emoji' => '👁️', 'name' => 'QA UX'],
    ...
    /*
    | Colonnes Kanban (ordre d'affichage). Les slugs rôle correspondent à current_role.
    */
    'kanban_column_order' => [
        'backlog',
        'pm',
    ...
    'kanban_columns' => [
        ...
        'pm' => ['label' => 'Product Manager', 'emoji' => '🧠', 'role' => 'pm'],
        'test_lead' => ['label' => 'Test Lead', 'emoji' => '📋', 'role' => 'test_lead'],
        'ux' => ['label' => 'UX Designer', 'emoji' => '🎨', 'role' => 'ux'],
        'dev' => [
            'label' => 'Dev',
            'emoji' => '💻',
            'hint' => 'Prêt pour Hermes / cron MCP',
        ],
        'qa' => ['label' => 'QA', 'emoji' => '🧪', 'role' => 'qa'],
        'qa_ux' => ['label' => 'QA UX', 'emoji' => '👁️', 'role' => 'qa_ux'],
        'security' => ['label' => 'Security', 'emoji' => '🔒', 'role' => 'security'],
